...
public class GameRepositoryWithMap implements IGameRepository //schauen ob die player ein eigenes repository
{
    ...
    public GameRepositoryWithMap(Map<Long, Game> gamemap, Map<String,Player> playermap)
    {
    ...
    public List<Game> findAllGames()
    {
        ...
        for (Map.Entry<Long,Game> e: gamemap.entrySet()) {
    ...
    public Game createGame(Game game) throws CannotCreateException
    {
        ...
        try {
            ...
            gamemap.put(Long.valueOf(game.getId()),game);
        }catch (Exception e){
    ...
    {
        return gamemap.get(Long.valueOf(gameId));
    }

//    @Override
//    public Game.GameStatus getStatus(String name)
//    {
...
//        switch(service)
//        {
//            case "game": this.service.setGames(service);
//            break;
//            case "dice": this.service.setDice(service);
//            break;
//            case "board": this.service.setBoards(service);
//            break;
//            case "bank": this.service.setBanks(service);
//            break;
//            case "broker": this.service.setBrokers(service);
//            break;
